        ...
        <div class="navbar-container content">
          <div class="collapse navbar-collapse show" id="navbar-mobile">
            <ul class="nav navbar-nav mr-auto float-left">
              ...
              <li class="nav-item dropdown navbar-search"><a class="nav-link dropdown-toggle hide" data-toggle="dropdown" href="#"><i class="ficon ft-searchhhh"></i></a>
              ...
              <li class="dropdown dropdown-notification nav-item">
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  <div class="arrow_box_right">
                    ...
                    <li class="scrollable-container media-list w-100"><a href="javascript:void(0)">
                        <div class="media">
                          <div class="media-left"><span class="avatar avatar-sm rounded-circle"><img src="<?php echo base_url(); ?>assets/app-assets/images/portrait/small/avatar-s-6.png" alt="avatar"></span></div>
                          <div class="media-body">
                        ...
                        <div class="media">
                          <div class="media-left"><span class="avatar avatar-sm rounded-circle"><img src="<?php echo base_url(); ?>assets/app-assets/images/portrait/small/avatar-s-3.png" alt="avatar"></span></div>
                          <div class="media-body">
                        ...
                        <div class="media">
                          <div class="media-left"><span class="avatar avatar-sm rounded-circle"><img src="<?php echo base_url(); ?>assets/app-assets/images/portrait/small/avatar-s-19.png" alt="avatar"></span></div>
                          <div class="media-body">
              ...
              <li class="dropdown dropdown-user nav-item">
                <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"> 
                  ...
                  <!-- <span class="avatar avatar-online">
                    <img src="<?php echo $this->session->userdata('sess_foto'); ?>" style="height: 35px; width: 35px" alt="avatar">
                  </span> -->
                </a>
                <div class="dropdown-menu dropdown-menu-right">
                  <!-- <div class="arrow_box_right"> -->
                    <!-- <a class="dropdown-item" href="#">
                      <span class="avatar avatar-online">
                        <img src="<?php echo $this->session->userdata('sess_foto'); ?>" style="height: 35px; width: 35px" alt="avatar">
                        <span class="user-name text-bold-700 ml-1"><?php echo $this->session->userdata('sess_user_id'); ?></span>
                      </span>
                    </a> -->
                    <!--
                    ...
                    -->
                    <!-- <div class="dropdown-divider"></div> -->
                    <a class="dropdown-item" href="<?php echo base_url(); ?>index.php/login/logout"><i class="ft-power"></i> Logout</a>
                  </div>
                </div>
              </li>
    ...
    <!-- LEFT MENU -->
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true" data-img="<?php echo base_url(); ?>assets/app-assets/images/backgrounds/<?php echo $this->session->userdata('sess_background_file'); ?>">
      <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">       
          <li class="nav-item mr-auto"><a class="navbar-brand" href="<?php echo base_url(); ?>"><img class="brand-logo" alt="Chameleon admin logo" src="<?php echo base_url(); ?>assets/app-assets/images/logo/logo.png"/>
              <h3 class="brand-text">tes POS</h3></a></li>
      ...
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          ...
          <li class=" nav-item"><a href="<?php echo base_url(); ?>index.php/data_master/master_produk"><i class="ficon ft-file"></i></i><span class="menu-title" data-i18n="">Produk</span></a>
          </li>

          <?php if ($this->session->userdata('sess_id_role') == 1) { ?>
            <li class=" nav-item"><a href="<?php echo base_url(); ?>index.php/data_master/master_kategori_produk"><i class="ficon ft-file"></i></i><span class="menu-title" data-i18n="">Kategori Produk</span></a>
            </li>
          <?php } ?>
