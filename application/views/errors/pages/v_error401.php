...
<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>Error 401 - Telkom Akses</title>
  ...
  <body class="vertical-layout vertical-menu 1-column  bg-gradient-directional-danger menu-expanded blank-page blank-page" data-open="click" data-menu="vertical-menu" data-color="bg-gradient-x-purple-blue" data-col="1-column">
    <!-- ////////////////////////////////////////////////////////////////////////////-->
        ...
        <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="col-md-4 col-10 p-0">
                <div class="card-header bg-transparent border-0">
                    ...
                    <h3 class="text-uppercase text-center white">Error<br/>Unauthorized Access</h3>
                </div>
                <div class="card-content">
                    ...
                    <div class="row py-2 text-center">
                        <div class="col-12">
                            <a href="<?php echo base_url(); ?>" class="btn btn-white danger box-shadow-4"><i class="ft-home"></i> Back to Home</a>
                        </div>
                ...
                <div class="card-footer bg-transparent">
                    <div class="row">
                        <p class="text-muted text-center col-12 py-1 white">© 2019 <a href="#" class="white text-bold-700">Telkom Akses </a>Crafted with <i class="ft-heart white "> </i> </p>
